...
it('polls participants every minute in the background', function (): void {
    ...
    expect($pollingEvent)->toBeInstanceOf(Event::class)
        ...
        ->and($pollingEvent?->runInBackground)->toBeTrue()
        ->and($pollingEvent?->buildCommand())->toContain('schedule:finish');
});
